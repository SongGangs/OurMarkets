 ...
 * 
 * @see ourmarket.models.Collection
...
public class CollectionDAO extends BaseHibernateDAO {
	...
	public Collection findById(java.lang.Integer id) {
		...
		try {
			Collection instance = (Collection) getSession().get("ourmarket.models.Collection", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Collection instance) {
		...
		try {
			List results = getSession().createCriteria("ourmarket.models.Collection").add(Example.create(instance))
					.list();
